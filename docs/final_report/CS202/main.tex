...
\noindent \newline
\noindent \newline
\noindent \newline \makebox[\textwidth]{\includegraphics[scale=0.3]{images/logohcmus.png}}
...
Here is the class diagram of the project (with some modifications for the sake of clarity): \textbf{TBDTBDTBD}
